            ...
            <div class="main-bar clearfix ">
                <div class="container clearfix">
                    ...
                    <div class="logo-header">
                        <a href="/"><img class="logo-3" src="images/medha_white.png" alt=""></a>
                    </div>
                    <!-- Nav Toggle Button -->
                    ...
                    <div class="extra-nav">
                        <div class="extra-cell">
                            <a href="/#gettouch" class="btn btn-corner gradient btn-primary"><i class="fa fa-angle-right m-r10"></i>Get in touch</a>
                        </div>
                    </div>
                    <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                        ...
                        <ul class="nav navbar-nav navbar">
                            <li><a href="/">Home</a></li>
                            <li class="active"><a href="javascript:void(0);"><span>About</span><i class="fa fa-chevron-down"></i></a>
                                <ul class="sub-menu">
                                    <li><a href="/about">About Medha Digital</a></li>
                                    <li><a href="/aboutteam">About Our Team</a></li>
                            ...
                            <ul>
                               <!--  <li>
                                ...
                                <li>
                                    ...
                                    <a href="mailto:team@medha.digital" target="_blank" class="text-white">medhadigitalsolutions@gmail.com</a>
                                </li>
